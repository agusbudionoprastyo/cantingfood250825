...
class WhatsAppService
{
    ...
    {
        $this->enabled = (bool) Settings::group('whatsapp_gateway')->get('whatsapp_enabled', false);
        $this->apiUrl = (string) Settings::group('whatsapp_gateway')->get('whatsapp_api_url', '');
        $this->session = (string) Settings::group('whatsapp_gateway')->get('whatsapp_session', '');
        $this->phone = (string) Settings::group('whatsapp_gateway')->get('whatsapp_phone', '');
        $this->companyName = (string) Settings::group('whatsapp_gateway')->get('whatsapp_company_name', 'Canting Food');
        $this->messageTemplate = (string) Settings::group('whatsapp_gateway')->get('whatsapp_message_template', '');
    }
