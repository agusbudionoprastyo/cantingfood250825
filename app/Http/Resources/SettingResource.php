...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'whatsapp_enabled'                    => $this->info['whatsapp_enabled'] ?? false,
            'whatsapp_api_url'                    => $this->info['whatsapp_api_url'] ?? '',
            'whatsapp_session'                    => $this->info['whatsapp_session'] ?? '',
            'whatsapp_phone'                      => $this->info['whatsapp_phone'] ?? '',
            'whatsapp_company_name'               => $this->info['whatsapp_company_name'] ?? 'Canting Food',
            'whatsapp_message_template'           => $this->info['whatsapp_message_template'] ?? '',
